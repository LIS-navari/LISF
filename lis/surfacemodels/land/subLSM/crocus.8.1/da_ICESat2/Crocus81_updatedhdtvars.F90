...
!BOP
! !ROUTINE: Crocus81_updatedhdtvars
! \label{Crocus81_updatedhdtvars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine Crocus81_updatedhdtvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
!Use the model's snow density from the previous timestep
  ...
  enddo
#endif
end subroutine Crocus81_updatedhdtvars
